export type RetrievalKind = "vector" | "keyword" | "graph" | "hybrid";

/**
 * The API tags each citation's retrieval_path as one of "vector"/"keyword"/"graph",
 * or a "+"-joined combination (e.g. "graph+keyword+vector") when the reranker
 * found the same chunk via more than one retriever.
 */
